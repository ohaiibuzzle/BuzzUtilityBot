...
async def test_avatar():
    ...
    async with aiohttp.ClientSession(timeout=timeout) as session:
        raw_icon = await session.get(
            str(
                "https://cdn.discordapp.com/avatars/169257697345011712/fa1ff14e7510ea22f1cd72baeaa1bbb0.webp"
            )
        )
        ...
        # deprecated in Pillow 8.0.0

        text_w = int(draw.textlength(member_msg, font=text_font))
        # get height by multiplying the number of lines by the font size
